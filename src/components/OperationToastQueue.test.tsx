...
type ToastPortalMock = { operationToasts: OperationToast[]; dismissOperationToast: ReturnType<typeof vi.fn> };

const portal = vi.hoisted((): ToastPortalMock => ({ operationToasts: [], dismissOperationToast: vi.fn() }));
