...
function pagingConfig(descriptor) {
  ...
  const maximum =
    Number.isInteger(sizeParameter?.maximum) && sizeParameter.maximum > 0
      ? Math.min(sizeParameter.maximum, MAXIMUM_SIZE)
      : MAXIMUM_SIZE;
  const requestedSize =
    Number.isInteger(sizeParameter?.defaultValue) && sizeParameter.defaultValue > 0 ? sizeParameter.defaultValue : FALLBACK_SIZE;
  return {
    page:
      Number.isInteger(pageParameter?.defaultValue) && pageParameter.defaultValue >= 0
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              ...
                              disabled={
                                ...
                                (activeQuery && !activePageParameter)
                              }
                              onClick={() => changeGridPage(displayedPage + 1)}
                            >
